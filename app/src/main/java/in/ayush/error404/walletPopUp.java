...
public class walletPopUp {
    public void showPopupWindow(final View view, String data, Context context) {


        //Create a View object yourself through inflater
        LayoutInflater inflater = (LayoutInflater) view.getContext().getSystemService(view.getContext().LAYOUT_INFLATER_SERVICE);
        View popupView = inflater.inflate(R.layout.wallet_pop, null);
        ...
        TextView text = popupView.findViewById(R.id.textView95);
        text.setText("Available Balance : "+data);
